...
//	{ stringAST, 3 * 60 },    // Arabia Standard Time
	...
	{ stringBRST, -2 * 60 },    // Bras�lia Summer Time
	{ stringBRT, -3 * 60 },    // Bras�lia Time
...
//	{ stringECT, -5 * 60 },    // Ecuador Time
	...
	{ stringGALT, -6 * 60 },    // Gal�pagos Time
...
//	{ stringGST, -2 * 60 },    // South Georgia and the South Sandwich Islands Time
	...
	{ stringHAEC, 2 * 60 },    // Heure Avanc�e d'Europe Centrale French-language name for CEST
