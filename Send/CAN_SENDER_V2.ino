...
const int potentiometerPin2 = 1;    // Use a valid ADC pin on ESP32 for petensiometer
...
void readAndSendSensorData() {
    ...
    int16_t potentiometerValue2 = analogRead(potentiometerPin2);
    ...
    sendCanData(201,potentiometerValue2,gx,gy,gz); // We must change potetiometer value with hall effect sensor value
